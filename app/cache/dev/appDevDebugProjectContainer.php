...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'corepost.service' => 'getCorepost_ServiceService',
            'coretool.service' => 'getCoretool_ServiceService',
            'coreuser.service' => 'getCoreuser_ServiceService',
            ...
            'doctrine.dbal.core_connection' => 'getDoctrine_Dbal_CoreConnectionService',
            'doctrine.dbal.ettracking_connection' => 'getDoctrine_Dbal_EttrackingConnectionService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.core' => 'getDoctrine_Dbal_Logger_Profiling_CoreService',
            'doctrine.dbal.logger.profiling.ettracking' => 'getDoctrine_Dbal_Logger_Profiling_EttrackingService',
            'doctrine.orm.default_entity_listener_resolver' => 'getDoctrine_Orm_DefaultEntityListenerResolverService',
            'doctrine.orm.default_entity_manager' => 'getDoctrine_Orm_DefaultEntityManagerService',
            'doctrine.orm.default_manager_configurator' => 'getDoctrine_Orm_DefaultManagerConfiguratorService',
            'doctrine.orm.ettracking_entity_listener_resolver' => 'getDoctrine_Orm_EttrackingEntityListenerResolverService',
            'doctrine.orm.ettracking_entity_manager' => 'getDoctrine_Orm_EttrackingEntityManagerService',
            'doctrine.orm.ettracking_manager_configurator' => 'getDoctrine_Orm_EttrackingManagerConfiguratorService',
            ...
            'doctrine_cache.providers.doctrine.orm.ettracking_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_EttrackingMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.ettracking_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_EttrackingQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.ettracking_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_EttrackingResultCacheService',
        ...
        $this->aliases = array(
            ...
            'database_connection' => 'doctrine.dbal.core_connection',
            'doctrine.orm.default_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.default_metadata_cache',
            'doctrine.orm.default_query_cache' => 'doctrine_cache.providers.doctrine.orm.default_query_cache',
            'doctrine.orm.default_result_cache' => 'doctrine_cache.providers.doctrine.orm.default_result_cache',
            'doctrine.orm.entity_manager' => 'doctrine.orm.default_entity_manager',
            'doctrine.orm.ettracking_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.ettracking_metadata_cache',
            'doctrine.orm.ettracking_query_cache' => 'doctrine_cache.providers.doctrine.orm.ettracking_query_cache',
            'doctrine.orm.ettracking_result_cache' => 'doctrine_cache.providers.doctrine.orm.ettracking_result_cache',
    ...
    /**
     * Gets the 'corepost.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \core\postBundle\Service\postService A core\postBundle\Service\postService instance.
     */
    protected function getCorepost_ServiceService()
    {
        return $this->services['corepost.service'] = new \core\postBundle\Service\postService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'coretool.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \core\toolBundle\Service\toolService A core\toolBundle\Service\toolService instance.
     */
    protected function getCoretool_ServiceService()
    {
        return $this->services['coretool.service'] = new \core\toolBundle\Service\toolService($this->get('doctrine.orm.ettracking_entity_manager'));
    }

    /**
     * Gets the 'coreuser.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \core\userBundle\Service\userService A core\userBundle\Service\userService instance.
     */
    protected function getCoreuser_ServiceService()
    {
        return $this->services['coreuser.service'] = new \core\userBundle\Service\userService($this->get('doctrine.orm.ettracking_entity_manager'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('core' => 'doctrine.dbal.core_connection', 'etTracking' => 'doctrine.dbal.etTracking_connection'), array('default' => 'doctrine.orm.default_entity_manager', 'etTracking' => 'doctrine.orm.etTracking_entity_manager'), 'core', 'default');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.core_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_CoreConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.core'));

        $b = new \Doctrine\DBAL\Configuration();
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.core_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'dev.db.asset.existery.com', 'port' => NULL, 'dbname' => 'etAsset', 'user' => 'root', 'password' => 'etadmin2015', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }

    /**
     * Gets the 'doctrine.dbal.ettracking_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\DBAL\Connection A Doctrine\DBAL\Connection instance.
     */
    protected function getDoctrine_Dbal_EttrackingConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.ettracking'));

        $b = new \Doctrine\DBAL\Configuration();
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.ettracking_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'dev.db.asset.existery.com', 'port' => NULL, 'dbname' => 'etTracking', 'user' => 'root', 'password' => 'etadmin2015', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/core/postBundle/Entity'), 1 => ($this->targetDirs[3].'/src/core/userBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'core\\postBundle\\Entity');
        $c->addDriver($b, 'core\\userBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('corepostBundle' => 'core\\postBundle\\Entity', 'coreuserBundle' => 'core\\userBundle\\Entity'));
        ...
        $this->services['doctrine.orm.default_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.core_connection'), $d);
    ...
    /**
     * Gets the 'doctrine.orm.ettracking_entity_listener_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\Mapping\DefaultEntityListenerResolver A Doctrine\ORM\Mapping\DefaultEntityListenerResolver instance.
     */
    protected function getDoctrine_Orm_EttrackingEntityListenerResolverService()
    {
        return $this->services['doctrine.orm.ettracking_entity_listener_resolver'] = new \Doctrine\ORM\Mapping\DefaultEntityListenerResolver();
    }

    /**
     * Gets the 'doctrine.orm.ettracking_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_EttrackingEntityManagerService()
    {
        $a = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/core/toolBundle/Entity'))), 'core\\toolBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('coretoolBundle' => 'core\\toolBundle\\Entity'));
        $b->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.ettracking_metadata_cache'));
        $b->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.ettracking_query_cache'));
        $b->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.ettracking_result_cache'));
        ...
        $b->setEntityListenerResolver($this->get('doctrine.orm.ettracking_entity_listener_resolver'));

        $this->services['doctrine.orm.ettracking_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.ettracking_connection'), $b);

        $this->get('doctrine.orm.ettracking_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.ettracking_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance.
     */
    protected function getDoctrine_Orm_EttrackingManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.ettracking_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_44190ee88166de67f3089f3363ed132849e4d7ac6d14232994123f791369c68b');
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.ettracking_metadata_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_EttrackingMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.ettracking_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf2orm_etTracking_44190ee88166de67f3089f3363ed132849e4d7ac6d14232994123f791369c68b');

        return $instance;
    }

    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.ettracking_query_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_EttrackingQueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.ettracking_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.ettracking_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_EttrackingResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.ettracking_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('core', $this->get('doctrine.dbal.logger.profiling.core'));
        $d->addLogger('etTracking', $this->get('doctrine.dbal.logger.profiling.ettracking'));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'mainBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/core/postBundle/Resources/views'), 'corepost');
        $instance->addPath(($this->targetDirs[3].'/src/core/toolBundle/Resources/views'), 'coretool');
        $instance->addPath(($this->targetDirs[3].'/src/core/userBundle/Resources/views'), 'coreuser');
        $instance->addPath(($this->targetDirs[3].'/src/app/toolBundle/Resources/views'), 'apptool');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a908adf25b7adbdbb36e98301fba5cd80bca1150');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.core' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_Logger_Profiling_CoreService()
    {
        return $this->services['doctrine.dbal.logger.profiling.core'] = new \Doctrine\DBAL\Logging\DebugStack();
    }

    /**
     * Gets the 'doctrine.dbal.logger.profiling.ettracking' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_EttrackingService()
    {
        return $this->services['doctrine.dbal.logger.profiling.ettracking'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55baf623203dd')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'corepostBundle' => 'core\\postBundle\\corepostBundle',
                'coretoolBundle' => 'core\\toolBundle\\coretoolBundle',
                'coreuserBundle' => 'core\\userBundle\\coreuserBundle',
                'apptoolBundle' => 'app\\toolBundle\\apptoolBundle',
            ...
            'database_host' => 'dev.db.asset.existery.com',
            'database_port' => NULL,
            'database_name' => 'etAsset',
            'database_user' => 'root',
            'database_password' => 'etadmin2015',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'a908adf25b7adbdbb36e98301fba5cd80bca1150',
            'locale' => 'en',
            'database_driver' => 'pdo_mysql',
            'database_driver_t' => 'pdo_mysql',
            'database_host_t' => 'dev.db.asset.existery.com',
            'database_port_t' => NULL,
            'database_name_t' => 'etTracking',
            'database_user_t' => 'root',
            'database_password_t' => 'etadmin2015',
            ...
            'kernel.secret' => 'a908adf25b7adbdbb36e98301fba5cd80bca1150',
            ...
            'doctrine.entity_managers' => array(
                ...
                'etTracking' => 'doctrine.orm.etTracking_entity_manager',
            ),
            ...
            'doctrine.connections' => array(
                ...
                'etTracking' => 'doctrine.dbal.etTracking_connection',
            ),
            'doctrine.default_connection' => 'core',
