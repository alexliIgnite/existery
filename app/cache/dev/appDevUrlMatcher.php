...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/e0b0593')) {
            // _assetic_e0b0593
            if ($pathinfo === '/css/e0b0593.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'e0b0593',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_e0b0593',);
            }

            if (0 === strpos($pathinfo, '/css/e0b0593_part_1_')) {
                // _assetic_e0b0593_0
                if ($pathinfo === '/css/e0b0593_part_1_feedBar_1.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'e0b0593',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_e0b0593_0',);
                }

                // _assetic_e0b0593_1
                if ($pathinfo === '/css/e0b0593_part_1_post_2.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'e0b0593',  'pos' => 1,  '_format' => 'css',  '_route' => '_assetic_e0b0593_1',);
                }
        ...
        if (0 === strpos($pathinfo, '/js/1979e5b')) {
            // _assetic_1979e5b
            if ($pathinfo === '/js/1979e5b.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '1979e5b',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_1979e5b',);
            }

            // _assetic_1979e5b_0
            if ($pathinfo === '/js/1979e5b_part_1_post_1.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '1979e5b',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_1979e5b_0',);
            }
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            ...
            // corepost_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'corepost_homepage')), array (  '_controller' => 'core\\postBundle\\Controller\\DefaultController::indexAction',));
            }
        ...
        // getFullPost
        if (0 === strpos($pathinfo, '/getFullPost') && preg_match('#^/getFullPost/(?P<ptid>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'getFullPost')), array (  '_controller' => 'mainBundle\\Controller\\postController::getFullPostAction',));
        }
